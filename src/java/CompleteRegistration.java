...
public class CompleteRegistration extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CompleteRegistration</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CompleteRegistration at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(Sex+","+dob+","+Lang+","+email);
        Connection conn =MyDatabaseConnection.GetDBConnection();
        Statement stmt = null;
        try
        {
            stmt = conn.createStatement();
            String sql = "UPDATE TECHZIZZUSER SET sex='"+Sex+"' , dob='"+dob+"' , lang='"+Lang+"' where email='"+email+"'"; 
